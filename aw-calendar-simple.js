...
class AwCalendarSimple extends AwExternsFunctionsMixin( PolymerElement ) {
	...
	static get properties() {
		return {
			diasMonth: { type: Array, value: [] },
			inputsYears: { type: Object, value: {} },
			inputsHours: { type: Object, value: {} },

			lang: { type: String, value: "es" },
			diasinitial: { type: Array, value: [] },
			dias: { type: Array, value: [] },
			diasshort: { type: Array, value: [] },
			meses: { type: Array, value: [] },
			mesesshort: { type: Array, value: [] },
			txtHora: { type: String, value: "" },

			name: { type: String, value: "" },
			time: { type: Boolean, value: false },
			fechainit: { type: String, value: "" },
			...
			isanimate: { type: Boolean, value: false },
			event: { type: Object, value: {} },
			festivos: { type: Array, value: [] },

			listenInputsYear: { type: Function },
			listenInputsHour: { type: Function },
